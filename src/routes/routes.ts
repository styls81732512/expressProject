...
const models: TsoaRoute.Models = {
    ...
    "PaginationRo_User-Array_": {
        ...
        "properties": {
            ...
            "data": {"dataType":"array","array":{"dataType":"array","array":{"dataType":"refObject","ref":"User"}},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    // ###########################################################################################################
        ...
        app.get('/user/list',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    dto: {"in":"queries","name":"dto","required":true,"ref":"FindAllUserDto"},
                    response: {"in":"res","name":"200","required":true,"ref":"PaginationRo_User-Array_"},
            };
        ...
        app.get('/user/:id',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.findOne)),

            async function UserController_findOne(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
                    response: {"in":"res","name":"200","required":true,"ref":"User"},
            };
        ...
        app.post('/user',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    ...
                    response: {"in":"res","name":"201","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"id":{"dataType":"double","required":true}}},
            };
        ...
        app.put('/user/:id',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    ...
                    response: {"in":"res","name":"200","required":true,"dataType":"enum","enums":[null]},
            };
